...
-(void)goscene1{
    ...
    CCSprite *font1 = [CCSprite spriteWithFile:@"teach-fish.png"];
    [font1 setPosition:ccp(screenSize.width*0.5 ,screenSize.height*0.76)];
    [self addChild:font1 z:5];
    

    CCSpriteBatchNode* touchstart = [CCSprite spriteWithFile:@"teach-start1.png"];
    ...
    {
        NSString *naback = [NSString stringWithFormat:@"teach-start%d.png", i];
        [anibackgroup  addFrameWithFilename:naback];
    }
...
-(void)goscene2{
    ...
    CCSprite *font1 = [CCSprite spriteWithFile:@"teach-balloon.png"];
    [font1 setPosition:ccp(screenSize.width*0.5 ,screenSize.height*0.76)];
    [self addChild:font1 z:5];
    
    
    CCSpriteBatchNode* touchstart = [CCSprite spriteWithFile:@"teach-start1.png"];
    [touchstart setPosition:ccp(screenSize.width*0.83,screenSize.height*0.67)];
    [self addChild:touchstart z:5];
    CCAnimation *anibackgroup = [CCAnimation animation];
    for(unsigned int i = 1; i <3; i++)
    {
...
-(void)goscene3{
    ...
    CCSprite *font1 = [CCSprite spriteWithFile:@"teach-pig.png"];
    [font1 setPosition:ccp(screenSize.width*0.5 ,screenSize.height*0.76)];
    [self addChild:font1 z:5];
    
    
    CCSpriteBatchNode* touchstart = [CCSprite spriteWithFile:@"teach-start1.png"];
    [touchstart setPosition:ccp(screenSize.width*0.74,screenSize.height*0.67)];
    [self addChild:touchstart z:5];
    CCAnimation *anibackgroup = [CCAnimation animation];
    for(unsigned int i = 1; i <3; i++)
    {
...
-(void)goscene4{
    ...
    CCSprite *font1 = [CCSprite spriteWithFile:@"teach-myzoo.png"];
    [font1 setPosition:ccp(screenSize.width*0.5 ,screenSize.height*0.76)];
    [self addChild:font1 z:5];

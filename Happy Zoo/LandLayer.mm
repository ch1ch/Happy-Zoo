...
-(id)init
{
    if ((self =[super init]))
    {
        ...
        [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"pig_land_long.plist"];
        ...
        [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"pig_land_car_long.plist"];
    ...
    */
    ...
    if (!gameoverb) {
       [self setPosition:newpos1]; 
        ...
        CGPoint postemp=pig.position;
        postemp.x=postemp.x+20;
        pig.position=postemp;
    }
    ...
    if (self.position.x<screenSize.width*(-10.6)) {
...
-(void)GameOvertest:(ccTime) dt {
   ...
   // NSLog(@"pig~ pos x=%f,y=%f.",pig.position.x,pig.position.y);
    ...
    if (self.position.x<screenSize.width*(-15.7)) {
              NSLog(@" you win!");
        gameoverb=YES;

        //[self simulateLongLoadingTime];
        if (pig.position.x>screenSize.width*16.7) {
            [self Gameovers];
        }
...
-(void)drawmonster{
    ...
    [decorate3_100 setPosition:ccp(screenSize.width*3.88,screenSize.height*(-0.45))];
    [self addChild:decorate3_100 z:13 tag:200];
    
    //天上花
    CCSpriteBatchNode *decorate2000=[CCSprite spriteWithSpriteFrameName:@"pigrun-decorate2.png"];
    [decorate2000 setPosition:ccp(screenSize.width*5.8,screenSize.height*(-0.3))];
    [self addChild:decorate2000 z:12 tag:200];
    
    CCSpriteBatchNode *decorate3000=[CCSprite spriteWithSpriteFrameName:@"pigrun-decorate3.png"];
    [decorate3000 setPosition:ccp(screenSize.width*5.8,screenSize.height*(-0.3))];
    [self addChild:decorate3000 z:13 tag:200];
    
    CCSpriteBatchNode *decorate4000=[CCSprite spriteWithSpriteFrameName:@"pigrun-decorate3.png"];
    [decorate4000 setPosition:ccp(screenSize.width*5.97,screenSize.height*(-0.45))];
    [self addChild:decorate4000 z:13 tag:200];
    
    CCSpriteBatchNode *decorate3_1000=[CCSprite spriteWithSpriteFrameName:@"pigrun-decorate3.png"];
    ...
    [decorate5 setPosition:ccp(screenSize.width*7.13,screenSize.height*(-0.79))];
    ...
    [decorate3_2 setPosition:ccp(screenSize.width*7.10,screenSize.height*(-0.75))];
    ...
    [decorate3_3 setPosition:ccp(screenSize.width*7.19,screenSize.height*(-0.78))];
    ...
    [decorate7 setPosition:ccp(screenSize.width*8.17,screenSize.height*(-0.65))];
    ...
    [mayidong setPosition:ccp(screenSize.width*9.6 ,screenSize.height*(-0.72))];
    ...
    [decorate12 setPosition:ccp(screenSize.width*16.62,screenSize.height*(-0.6))];
...
- (void)drawland2 {
    ...
    [land2 setPosition:ccp(screenSize.width*1.88,screenSize.height*(-1.0))];
...
- (void)drawmons1 {
    ...
    [monster1 setPosition:ccp(screenSize.width*2.4,screenSize.height*(-0.83))];
...
- (void)drawland6 {
    ...
    land6 = [CCSprite spriteWithSpriteFrameName:@"pigrun-land06-long.png"];
    [land6 setPosition:ccp(screenSize.width*3.35,screenSize.height*(-1.07))];
...
- (void)drawland7 {
    ...
    [land7 setPosition:ccp(screenSize.width*4.8,screenSize.height*(-1.02))];
...
- (void)drawland10 {
    ...
    [land10 setPosition:ccp(screenSize.width*5.89,screenSize.height*(-1.00))];
...
- (void)drawland4 {
    ...
    [land4 setPosition:ccp(screenSize.width*6.44,screenSize.height*(-1.02))];
...
- (void)drawmons3 {
    ...
    [monster3 setPosition:ccp(screenSize.width*6.78,screenSize.height*(-0.85))];
...
- (void)drawland3 {
    ...
    [land3 setPosition:ccp(screenSize.width*7.87,screenSize.height*(-1.22))];
...
- (void)drawland8_1 {
    ...
    [land8_1 setPosition:ccp(screenSize.width*8.88,screenSize.height*(-0.77))];
...
- (void)drawland8_2 {
    ...
    [land8_2 setPosition:ccp(screenSize.width*9.09,screenSize.height*(-0.65))];
...
- (void)drawland6_2 {
    ...
    [land6_2 setPosition:ccp(screenSize.width*9.29,screenSize.height*(-1.0))];
...
- (void)drawmons4 {
    ...
    [monster4 setPosition:ccp(screenSize.width*9.63,screenSize.height*(-0.59))];
    [self addChild:monster4 z:12 tag:304];
...
- (void)drawland9 {
    ...
    land9.position = CGPointMake(screenSize.width*11.95,screenSize.height*(-1.05));
...
- (void)drawland3_2 {
    ...
    [land3_2 setPosition:ccp(screenSize.width*12.48,screenSize.height*(-1.0))];
...
- (void)drawmons6 {
    ...
    [monster6 setPosition:ccp(screenSize.width*12.95,screenSize.height*(-0.48))];
...
- (void)drawland11 {
    ...
    land11.position = CGPointMake(screenSize.width*13.56,screenSize.height*(-1.1));
...
- (void)drawland12 {
    ...
    land12.position = CGPointMake(screenSize.width*13.86,screenSize.height*(-1.1));
...
- (void)drawland13 {
    ...
    land13.position = CGPointMake(screenSize.width*14.16,screenSize.height*(-1.1));
...
- (void)drawland6_3 {
    ...
    [land6_3 setPosition:ccp(screenSize.width*14.52,screenSize.height*(-1.1))];
...
-(void)Gameovers{
    ...
    }else if (self.position.x<screenSize.width*(-9.4)){
        game3level=2;
          [[SimpleAudioEngine sharedEngine]stopBackgroundMusic];
    ...
    }else if(self.position.x<screenSize.width*(-5.4)){
        game3level=1;
          [[SimpleAudioEngine sharedEngine]stopBackgroundMusic];
